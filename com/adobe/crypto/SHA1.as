   ...
   public class SHA1 extends Object
   {
      ...
      public static function hashToBase64(param1:String) : String {
         ...
         while(_loc5_ < _loc3_.length)
         {
            ...
            _loc4_ = _loc4_ + String.fromCharCode(_loc7_);
            _loc5_++;
         }
      ...
      private static function hashBlocks(param1:Array) : ByteArray {
         ...
         var _loc3_:int = 4.023233417E9;
         var _loc4_:int = 2.562383102E9;
         var _loc5_:* = 271733878;
         var _loc6_:int = 3.28537752E9;
         ...
         while(_loc10_ < _loc7_)
         {
            ...
            while(_loc17_ < 60)
            {
               _loc9_ = _loc8_[_loc17_ - 3] ^ _loc8_[_loc17_ - 8] ^ _loc8_[_loc17_ - 14] ^ _loc8_[_loc17_ - 16];
               _loc8_[_loc17_] = _loc9_ << 1 | _loc9_ >>> 31;
               _loc9_ = (_loc12_ << 5 | _loc12_ >>> 27) + (_loc13_ & _loc14_ | _loc13_ & _loc15_ | _loc14_ & _loc15_) + _loc16_ + int(_loc8_[_loc17_]) + 2.400959708E9;
               _loc16_ = _loc15_;
               _loc15_ = _loc14_;
               _loc14_ = _loc13_ << 30 | _loc13_ >>> 2;
               _loc13_ = _loc12_;
            ...
            while(_loc17_ < 80)
            {
               _loc9_ = _loc8_[_loc17_ - 3] ^ _loc8_[_loc17_ - 8] ^ _loc8_[_loc17_ - 14] ^ _loc8_[_loc17_ - 16];
               _loc8_[_loc17_] = _loc9_ << 1 | _loc9_ >>> 31;
               _loc9_ = (_loc12_ << 5 | _loc12_ >>> 27) + (_loc13_ ^ _loc14_ ^ _loc15_) + _loc16_ + int(_loc8_[_loc17_]) + 3.395469782E9;
               _loc16_ = _loc15_;
               _loc15_ = _loc14_;
               _loc14_ = _loc13_ << 30 | _loc13_ >>> 2;
               _loc13_ = _loc12_;
